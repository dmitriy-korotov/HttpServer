#include <webcpp/http/Session.hpp>

#include <webcpp/system/FileLogger.hpp>
#include <webcpp/system/FileReader.hpp>
#include <webcpp/system/Time.hpp>

#include <webcpp/http/Request.hpp>
#include <webcpp/http/Response.hpp>
#include <webcpp/http/SessionManager.hpp>
#include <webcpp/http/HttpServer.hpp>
#include <webcpp/http/ResponseTemplates.hpp>
...
namespace http
{
	...
	catch (const std::exception& _ex)
	{
		...
		return response::templates::getBadResponse(beast_http::status::internal_server_error, SERVER_NAME.data());
	}
}